...
import 'package:simple_state/views/product_info.dart';

class ProductItem extends StatelessWidget {
  final ProductData product;
  final bool btnMore;

  const ProductItem({Key? key, required this.product, required this.btnMore}) : super(key: key);
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                context.read<ProductState>().addToCart(product);
              },
            ),
          ),
          if (btnMore)
