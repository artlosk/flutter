...
import 'package:cubit_from_package/views/cart_list.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter/material.dart';
import 'package:cubit_from_package/models/tab_item.dart';
import 'package:cubit_from_package/states/product_state.dart';
import 'package:cubit_from_package/views/product_list.dart';
                ...
                builder: (context, tabState) {
                  return Scaffold(
                    ...
                    bottomNavigationBar: BottomNavigationBar(
                      ...
                      onTap: (index) {
                        context.read<TabCubit>().updateTab(index);
                      },
                      items: [
