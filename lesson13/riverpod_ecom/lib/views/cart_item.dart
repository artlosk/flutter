...
import 'package:riverpod_ecom/views/product_info.dart';
              ...
              children: <Widget>[
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      context.read(cartProvider.notifier).deleteItemFromCart(product.product.id);
                    },
                  ),
                ),
                Expanded(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(text: product.qty.toInt().toString(), style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          )
